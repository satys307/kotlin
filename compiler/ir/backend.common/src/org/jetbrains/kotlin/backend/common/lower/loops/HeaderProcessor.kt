        ...
        with(builder) {
            ...
            when (headerInfo.direction) {
                ...
                ProgressionDirection.UNKNOWN -> {
                    ...
                    context.oror(
                        context.andand(
                            irCall(builtIns.greaterFunByOperandType.getValue(stepType.classifierOrFail)).apply {
                        ...
                        context.andand(
                            irCall(builtIns.lessFunByOperandType.getValue(stepType.classifierOrFail)).apply {
                                putValueArgument(0, stepExpression)
                                putValueArgument(1, if (progressionType.isLong) irLong(0) else irInt(0))
                            },
